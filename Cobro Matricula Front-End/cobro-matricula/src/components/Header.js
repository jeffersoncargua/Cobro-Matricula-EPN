		...
		<div className="bg-white border-gray-200 dark:bg-gray-900">
			<div className=" flex items-center justify-center mx-auto p-4 bg-sky-200/60">
				...
				>
					<img
						src={Logo}
						className="h-28 border border-slate-400"
						alt="Flowbite Logo"
					/>
			...
			<nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
				<div className="max-w-screen-xl flex flex-wrap items-center justify-start mx-auto p-4">
					...
					<div
						className={`${!enableMenu && "hidden"}  w-full md:block md:w-auto`}
						...
						<ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
							<li className="flex items-center hover:text-blue-700">
								<svg
									...
									aria-label="Menu"
									fill="currentColor"
									className="bi bi-house-door w-5 h-5 ms-1.5 me-1.5"
									viewBox="0 0 16 16"
								>
								...
								<>
									<li className="hover:text-blue-700">
										...
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
												aria-label="GestionUser"
												fill="currentColor"
												className="bi bi-people w-5 h-5 md:ms-1.5 me-1.5"
												viewBox="0 0 16 16"
											>
											...
											Gestion de Usuarios
											<svg
												className="w-2.5 h-2.5 ms-2.5 max-md:ml-auto"
												aria-hidden="true"
												xmlns="http://www.w3.org/2000/svg"
												fill="none"
												viewBox="0 0 10 6"
										...
										<div
											id="dropdownNavbar"
											onMouseLeave={() => setEnableDrop(false)}
											className={`z-10 md:absolute ${!enableDrop && "hidden"} md:bg-slate-50/95 md:rounded-b-lg font-normal bg-white divide-y divide-gray-100 md:mt-2.5 md:border-b md:border-x md:border-slate-500 shadow-sm md:w-52`}
										>
											<ul
                        ...
                        <li>
                          <NavLink to='parameters/tecnologia' onClick={()=>{setEnableDrop(false);setEnableMenu(false)}} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tecnología</NavLink>
										...
										<svg
											...
											aria-label="param"
											fill="currentColor"
											className="bi bi-calculator w-5 h-5 ms-1.5 me-1.5"
											viewBox="0 0 16 16"
										>
