...
export const FormRegistration = () => {
  ...
  return (
    ...
    <form className="group text-slate-50" onSubmit={() => handleSubmit()}>
        ...
        <div className="flex items-start mb-6">
            ...
            <label htmlFor="remember" className="ms-2 text-sm font-medium  dark:text-gray-300">I agree with the <Link to='/' className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</Link>.</label>
        </div>
