...
export const FormRegistration = () => {
	...
	return (
		<form
			className=" w-full md:w-1/2 text-slate-900 p-4 m-4 border border-slate-100 rounded-lg bg-gradient-to-r from-indigo-500/75 from-10% via-sky-500 via-30% to-emerald-500/75 to-90%"
		...
		>
			<div className="grid gap-6 mb-6 md:grid-cols-2  ">
				...
				<div>
					...
					/>
					{errors.lastName && (
						<ErrorMessageValidator message={errors.lastName.message} />
					)}
				</div>
				<div>
					<label
			...
			<div className="mb-6">
				...
				<div className="w-full relative">
					...
					<button
						...
						className="absolute inset-y-0 end-0 flex items-center pe-2.5 text-black hover:text-cyan-600"
					>
						{enablePass
							? <svg
									xmlns="http://www.w3.org/2000/svg"
									fill="currentColor"
									className="bi bi-eye-fill w-5 h-5"
									viewBox="0 0 16 16"
								>
							...
							: <svg
									xmlns="http://www.w3.org/2000/svg"
									fill="currentColor"
									className="bi bi-eye-slash-fill w-5 h-5"
									viewBox="0 0 16 16"
								>
			...
			<div className="mb-6 ">
				...
				<div className="w-full relative ">
					...
					<button
						type="button"
						onClick={() => setEnableConfirmPass(!enableConfirmPass)}
						className="absolute inset-y-0 end-0 flex items-center pe-2.5 text-black hover:text-cyan-600"
					>
						{enableConfirmPass
							? <svg
				...
				{errors.confirmPass && (
					<ErrorMessageValidator message={errors.confirmPass.message} />
				)}
			</div>
