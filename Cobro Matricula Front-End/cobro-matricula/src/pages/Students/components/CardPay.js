export const CardPay = ({
	...
	return (
		...
		>
			...
			<span className="">
				Condicion de Gratuidad:{" "}
				<b className="font-bold italic text-red-600">{gratuidad}</b>
			</span>
				...
				<div className="border-l-[10px] border-indigo-500 mix-blend-multiply p-2 pb-4">
					<table className="w-[90%] mx-auto text-slate-950 text-center ">
						...
						<tfoot className="">
							<tr className="h-1"></tr>
							<tr className="">
								<td className="underline underline-offset-4 p-0.5">
									Total a Pagar:
								</td>
								<td className="text-white hover:scale-[1.1] bg-gradient-to-r from-red-700 from-20% via-orange-500 via-25% to-yellow-400 to-80% p-0.5">
									<div className="w-full bg-white text-black hover:text-white hover:bg-gradient-to-r hover:from-red-700 hover:from-19% hover:via-orange-500 hover:via-24% hover:to-yellow-400 hover:to-79% ">
										{" "}
										${" "}
										{recargoExtraordinaria === null
											? payment.valorTotal
											: payment.valorTotal + recargoExtraordinaria}{" "}
									</div>
								</td>
							</tr>
						</tfoot>
