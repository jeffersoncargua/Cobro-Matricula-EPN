						...
						<form className="group text-slate-900 p-4 border border-slate-100 rounded-lg " onSubmit={handleSubmit(handleEditParameters)}>
							...
							<section className="mt-6">
								<label htmlFor="porcentajeValorMin" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajeValorMin" {...register("porcentajeValorMin", {required: message.req.porcentajeValorMin, pattern: {value: patterns.decimal, message: message.porcentajeValorMin, }, valueAsNumber: true,})} defaultValue={baseParameters.porcentajeValorMin} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajeValorArancel" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajeValorArancel" {...register("porcentajeValorArancel", { required: message.req.porcentajeValorArancel, pattern: { value: patterns.decimal, message: message.porcentajeValorArancel,}, valueAsNumber: true, })} defaultValue={baseParameters.porcentajeValorArancel} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajePromedioAcademico" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajePromedioAcademico" {...register("porcentajePromedioAcademico", {required: message.req.porcentajePromedioAcademico, pattern: { value: patterns.decimal, message: message.porcentajePromedioAcademico, }, valueAsNumber: true, })} defaultValue={baseParameters.porcentajePromedioAcademico} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajePerdidaTemporal" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajePerdidaTemporal" {...register("porcentajePerdidaTemporal", {required: message.req.porcentajePerdidaTemporal, pattern: {value: patterns.decimal, message: message.porcentajePerdidaTemporal,}, valueAsNumber: true, })} defaultValue={baseParameters.porcentajePerdidaTemporal} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajeMatriculaExtraordinario" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajeMatriculaExtraordinario" {...register("porcentajeMatriculaExtraordinario", { required: message.req.porcentajeMatriculaExtraordinaria, pattern: {value: patterns.decimal, message: message.porcentajeMatriculaExtraordinaria,}, valueAsNumber: true, })} defaultValue={baseParameters.porcentajeMatriculaExtraordinario} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajeMatriculaEspecial" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajeMatriculaEspecial" {...register("porcentajeMatriculaEspecial", {required: message.req.porcentajeMatriculaEspecial, pattern: {value: patterns.decimal, message: message.porcentajeMatriculaEspecial,}, valueAsNumber: true, })} defaultValue={baseParameters.porcentajeMatriculaEspecial} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<section className="mt-6">
								<label htmlFor="porcentajeRecargoSegunda" className="relative">
									<input type="number" max={1.0} min={0.0} step={0.01} id="porcentajeRecargoSegunda" {...register("porcentajeRecargoSegunda", {required: message.req.porcentajeRecargoSegunda, pattern: {value: patterns.decimal,message: message.porcentajeRecargoSegunda,},valueAsNumber: true, })} defaultValue={baseParameters.porcentajeRecargoSegunda} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm"/>
									<span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
							...
							<button type="submit" className="mt-4 px-2.5 py-2 bg-blue-900 w-full text-white hover:bg-blue-700 hover:font-bold">
								Editar
							</button>
						</form>
					</div>
