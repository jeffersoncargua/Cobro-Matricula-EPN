...
export const ModalEditParameters = ({enableModalParameters, setEnableModalParameters, handleEditParameters}) => {
                    ...
                    <form className="group text-slate-900 p-4 border border-slate-100 rounded-lg " onSubmit={handleSubmit(handleEditParameters)}>
                        <section className="mt-2">
                            <label htmlFor="costoOptimo" className="relative">
                                <input  type='number' step={0.01} id="costoOptimo" {...register('costoOptimo',{required: message.req.costoOptimo, pattern:{value:patterns.decimal10000, message: message.costoOptimo}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                        ...
                        <section className="mt-6">
                            <label htmlFor="horaPeriodoAcademico" className="relative">
                                <input  type='number' step={1} id="horaPeriodoAcademico" {...register('horaPeriodoAcademico', {required: message.req.horaPeriodoAcademico, pattern:{value:patterns.entero1000, message: message.horaPeriodoAcademico}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="creditoPeriodoAcademico" className="relative">
                                <input  type='number' step={1} id="creditoPeriodoAcademico" {...register('creditoPeriodoAcademico',{required:message.req.creditoPeriodoAcademico, pattern:{value:patterns.entero100, message: message.creditoPeriodoAcademico}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeCostoOptimoAnual" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeCostoOptimoAnual" {...register('porcentajeCostoOptimoAnual', {required: message.req.porcentajeCostoOptimoAnual, pattern:{value:patterns.decimal, message:message.porcentajeCostoOptimoAnual}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeValorMin" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeValorMin" {...register('porcentajeValorMin',{required: message.req.porcentajeValorMin, pattern:{value:patterns.decimal, message:message.porcentajeValorMin}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeValorMax" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeValorMax" {...register('porcentajeValorMax', {required:message.req.porcentajeValorMax, pattern:{value:patterns.decimal, message:message.porcentajeValorMax}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeValorArancel" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeValorArancel" {...register('porcentajeValorArancel',{required:message.req.porcentajeValorArancel, pattern:{value:patterns.decimal, message:message.porcentajeValorArancel}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajePromedioAcademico" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajePromedioAcademico" {...register('porcentajePromedioAcademico', {required: message.req.porcentajePromedioAcademico, pattern:{value:patterns.decimal, message: message.porcentajePromedioAcademico}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajePerdidaTemporal" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajePerdidaTemporal" {...register('porcentajePerdidaTemporal',{required:message.req.porcentajePerdidaTemporal, pattern:{value:patterns.decimal, message:message.porcentajePerdidaTemporal}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeMatriculaEspecial" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeMatriculaEspecial" {...register('porcentajeMatriculaEspecial', {required: message.req.porcentajeMatriculaEspecial, pattern:{value:patterns.decimal, message: message.porcentajeMatriculaEspecial}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeRecargoSegunda" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeRecargoSegunda" {...register('porcentajeRecargoSegunda', { required: message.req.porcentajeRecargoSegunda, pattern:{value:patterns.decimal, message: message.porcentajeRecargoSegunda}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <section className="mt-6">
                            <label htmlFor="porcentajeRecargoTercera" className="relative">
                                <input  type='number' max={1.00} min={0.00} step={0.01} id="porcentajeRecargoTercera" {...register('porcentajeRecargoTercera',{required: message.req.porcentajeRecargoTercera, pattern:{value: patterns.decimal, message: message.porcentajeRecargoTercera}})} className="peer mt-0.5 p-2 w-full rounded border-gray-300 shadow-sm sm:text-sm" />
                                <span className="absolute inset-y-0 start-3 -translate-y-5 bg-white px-1 text-sm font-medium text-blue-600 transition-transform peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5">
                        ...
                        <button className="mt-4 px-2.5 py-2 bg-blue-900 w-full text-white hover:bg-blue-700 hover:font-bold">Editar</button>                       
                    </form>
                </div>
            </div>
        </div>
