...
export const ButtonEdit = ({ setEnableModalParameters }) => {
	...
	return (
		...
		<button type="button" onClick={() => setEnableModalParameters(true)} disabled={!enableButtonEdit} class="overflow-hidden relative w-16 p-2 h-10 bg-purple-500 text-white border-none rounded-md text-sm cursor-pointer relative z-10 group">
