...
export const UserCard = ({Photo, User, Action,handleOption}) => {
    ...
    return (
    <section className="flex flex-col items-center mx-auto gap-y-2.5">
        ...
        <button onClick={() => handleOption(Action)} className={styleColor}>{Action}</button>
    </section>
  )
}
