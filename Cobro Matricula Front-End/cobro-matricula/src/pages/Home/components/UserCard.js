...
export const UserCard = ({ Photo, User, Action, handleOption, enableForm }) => {
	...
	useEffect(() => {
		if (User === "Administrador") {
			setStyleColor(
				"px-3 py-2 bg-green-600 mb-4 rounded-lg hover:bg-green-700 hover:text-white",
			);
		} else {
			setStyleColor(
				"px-3 py-2 bg-blue-600 mb-4 rounded-lg hover:bg-blue-700 hover:text-white",
			);
		}
	}, [User]);
